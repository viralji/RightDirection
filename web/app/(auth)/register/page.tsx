    ...
    <div className="min-h-screen bg-surface flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="w-12 h-12 rounded-2xl bg-brand-500 flex items-center justify-center text-white font-bold text-xl mx-auto mb-4">RD</div>
              ...
              <div>
                ...
                <div className="flex">
                  <input value={form.subdomain} onChange={f('subdomain')} required placeholder="studyvision"
                    className="flex-1 px-3 py-2.5 bg-surface-card border border-surface-border rounded-l-lg text-text-primary placeholder:text-text-muted text-sm focus:outline-none focus:border-brand-500" />
