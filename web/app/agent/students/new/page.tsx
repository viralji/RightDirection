...
export default function NewStudentPage() {
  ...
  const mutation = useMutation({
    ...
    onSuccess: (student) => router.push(`/agent/students/${student.id}`),
  ...
  return (
    <div className="max-w-2xl space-y-6">
      <div className="flex items-center gap-3">
        <Link href="/agent/students" className="text-text-muted hover:text-text-primary"><ArrowLeft className="w-5 h-5" /></Link>
      ...
      <form onSubmit={submit} className="space-y-6">
        ...
        <div className="flex gap-3">
          <Link href="/agent/students" className="px-5 py-2.5 border border-surface-border text-text-secondary rounded-lg text-sm hover:bg-surface-card2">Cancel</Link>
